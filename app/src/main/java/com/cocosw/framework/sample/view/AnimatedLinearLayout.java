package com.cocosw.framework.sample.view;
...
public class AnimatedLinearLayout extends LinearLayout {
    ...
    private ObjectAnimator prepareNewChildAnimator(View child) {
        child.setAlpha(0f);
        return ObjectAnimator.ofFloat(child, "alpha", 0f, 1f);
    }

    private ObjectAnimator prepareBoundsAnimator(View child, ChildBounds bounds) {
